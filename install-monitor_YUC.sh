...
# CONFIGURACION
GITHUB_TOKEN="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"
VERSION="1.0.1 Expira Sep 20 2026"
...
install_service() {
    log_info "Iniciando instalacion de $NOMBRE_SERVICIO... Version: $VERSION"
    check_root
